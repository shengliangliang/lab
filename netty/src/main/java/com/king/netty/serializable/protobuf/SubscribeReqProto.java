...
// source: protoc_source/SubscribeReq.proto
...
public final class SubscribeReqProto {
  ...
  public interface SubscribeReqOrBuilder extends
    ...
    /**
     * <code>repeated string adress = 4;</code>
     */
     ...
     * <code>repeated string adress = 4;</code>
     */
    String getAdress(int index);
    /**
     * <code>repeated string adress = 4;</code>
     */
    com.google.protobuf.ByteString
        getAdressBytes(int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private SubscribeReq() {
      ...
      userName_ = "";
      productName_ = "";
      adress_ = com.google.protobuf.LazyStringArrayList.EMPTY;
    }
    ...
    private SubscribeReq(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
                adress_ = new com.google.protobuf.LazyStringArrayList();
        ...
        if (((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
          adress_ = adress_.getUnmodifiableView();
        }
    ...
    private com.google.protobuf.LazyStringList adress_;
    /**
     * <code>repeated string adress = 4;</code>
     */
    ...
    public com.google.protobuf.ByteString
        getAdressBytes(int index) {
      return adress_.getByteString(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < adress_.size(); i++) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 4, adress_.getRaw(i));
      }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        int dataSize = 0;
        for (int i = 0; i < adress_.size(); i++) {
          dataSize += computeStringSizeNoTag(adress_.getRaw(i));
        }
        size += dataSize;
        size += 1 * getAdressList().size();
      }
    ...
    public boolean equals(final Object obj) {
      ...
      result = result && getAdressList()
          .equals(other.getAdressList());
    ...
    public static final class Builder extends
      ...
      // Construct using com.king.netty.serializable.protobuf.SubscribeReqProto.SubscribeReq.newBuilder()
      private Builder() {
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.LazyStringList adress_ = com.google.protobuf.LazyStringArrayList.EMPTY;
      private void ensureAdressIsMutable() {
        if (!((bitField0_ & 0x00000008) == 0x00000008)) {
          adress_ = new com.google.protobuf.LazyStringArrayList(adress_);
      ...
      public com.google.protobuf.ProtocolStringList
          getAdressList() {
        return adress_.getUnmodifiableView();
      }
      /**
       * <code>repeated string adress = 4;</code>
       */
  ...
  static {
    String[] descriptorData = {
      "\n protoc_source/SubscribeReq.proto\"W\n\014Su" +
      "bscribeReq\022\020\n\010subReqId\030\001 \001(\005\022\020\n\010userName" +
      "\030\002 \001(\t\022\023\n\013productName\030\003 \001(\t\022\016\n\006adress\030\004 " +
      "\003(\tB9\n$com.king.netty.serializable.proto" +
      "bufB\021SubscribeReqProtob\006proto3"
    };
    ...
    internal_static_SubscribeReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SubscribeReq_descriptor,
        new String[] { "SubReqId", "UserName", "ProductName", "Adress", });
  }
