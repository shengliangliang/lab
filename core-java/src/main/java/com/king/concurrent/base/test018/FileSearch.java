...
public class FileSearch implements Runnable {
    ...
    // 现在，你必须实现一些要给run() 方法用的辅助方法。第一个是 directoryProcess()
    ...
    private void filterResults() {
        ...
        // 然后，浏览结果list里的所有元素。对于每个路径，为文件创建File对象 go through all the elements
    ...
    private boolean checkResults() {
        ...
        if (results.isEmpty()) {
            ...
            return false;
            // 另一种情况，如果结果list有元素，那么对象写信息到操控台表明情况，调用 Phaser对象懂得
